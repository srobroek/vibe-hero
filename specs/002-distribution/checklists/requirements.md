...
- Verified mechanics (npx-MCP shape, `${PLUGIN_ROOT}` token, generated plugin.json, the agentic-packages name-only dep bug) come from the research done before speccing and are reflected in FR-007/008/010/011 and Assumptions.
